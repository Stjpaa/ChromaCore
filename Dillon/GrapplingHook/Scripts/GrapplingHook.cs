...
namespace GrapplingHook
{
    ...
    public partial class GrapplingHook : Node
    {
        ...
        public override void _Ready()
        {
            ...
            RemoteTransform = Physics.HookStart.GetNode<RemoteTransform2D>("RemoteTransform2D");
        ...
        {
            _playerController.ChangeState(new PlayerController.States.Hooking(_playerController));
        }
        ...
        public void UpdateChainEndPosition()
        {
            ...
            Chain.LookAt(_playerController.GetHookStartPosition());
        }

        private int GetCurrentHookLength()
        {
            return Mathf.RoundToInt(_playerController.GetHookStartPosition().DistanceTo(Hook.GlobalPosition));
        }
        #endregion

        #region Getters

        public NodePath GetPlayerNodePath()
        {
            return _playerController.GetPath();
        }
        ...
        public Vector2 GetHookStartPosition()
        {
            ...
            return _playerController.GetHookStartPosition();
        }
